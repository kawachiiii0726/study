...
public class DBUpdate {
    ...
    private static final String JDBC_CONNECTION ="jdbc:postgresql://127.0.0.1:5432/jdbc_db?sslmode=disable";
    /** ・ユーザー名 */
    // 問② データベースのユーザー名を定数にしなさい
    private static final String USER ="postgres";
    /** ・パスワード */
    // 問③ データベースのパスワードを定数にしなさい。
    private static final String PASS ="hayal026jp";
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            connection = DriverManager.getConnection(
            		"jdbc:postgresql://127.0.0.1:5432/jdbc_db?sslmode=disable"	, "postgres", "hayal026jp");
